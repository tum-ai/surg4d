...
# python train.py -s  ${dataset_path} --port 6021 --expname cholecseg8k/${clip_name}_qwen_cat --configs arguments/cholecseg8k/no_tv.py --include_feature \
#     --language_features_name ${language_feature_name} --feature_level 0 --joint_coarse --no_dlang 1 --depth_loss_weight 2.0
