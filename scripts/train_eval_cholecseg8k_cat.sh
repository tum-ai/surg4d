...
#     --language_features_name ${language_feature_name} --feature_level 0 --joint_coarse --no_dlang 1
...
#     --feature_level 0 --skip_train --skip_test --configs arguments/cholecseg8k/default.py --mode ${mode} --no_dlang 1 --load_stage fine-lang 
# done
...
python extract_graph.py \
  ...
  --configs arguments/cholecseg8k/default.py --mode lang --no_dlang 1 --load_stage fine-lang \
  --num_views 5 \
